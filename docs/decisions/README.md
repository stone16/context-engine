...
- [0055 — Explicit accepted-observation scheduling](0055-schedule-accepted-file-observations-explicitly.md)
- [0056 — File deletion detection without tombstone authority](0056-detect-file-deletions-without-tombstone-authority.md)
- [0057 — Complete context layer thesis](0057-commit-to-the-complete-context-layer-thesis.md)
- [0058 — Dogfood workload pull](0058-pull-development-through-dogfood-workloads.md)
- [0059 — Explicit dogfood authentication composition](0059-admit-an-explicit-dogfood-authentication-composition.md)
- [0060 — Kernel-seam process ceremony split](0060-split-process-ceremony-along-the-kernel-seam-boundary.md)
