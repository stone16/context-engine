...
| M1 golden evaluation security | [0079 — Refuse authoritative evaluation without an executor](0079-refuse-authoritative-evaluation-without-an-executor.md) | File-only runs retain layered metrics but remain explicitly `REFUSED` until a real executor privately constructs security observations | Caller-authored counters/events/callbacks, synthetic factory imports outside tests, clean attestation without execution, or quality scores offsetting security |
...
- [0079 — Refuse authoritative evaluation without an executor](0079-refuse-authoritative-evaluation-without-an-executor.md)
