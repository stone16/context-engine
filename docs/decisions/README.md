...
| Rich Markdown compiler-runner | [0079 — Rich Markdown in an owned runner](0079-compile-rich-markdown-in-an-owned-runner.md) | Explicit v3 pure compilation accepts the closed rich grammar with exact source spans, same-Fragment ancestry, and a hard token ceiling while production activation stays deferred | Silent v1/v2 reinterpretation, runner-local state, unbounded Fragments, or activating publication without a separate decision |
| Rich Markdown runner closure | [0082 — Refine rich Markdown runner closure](0082-refine-rich-markdown-runner-closure.md) | Leading `---` is frontmatter only with a nonempty closing delimiter; exact v3 identities and a fixed subprocess timeout complete the typed runner contract | Position-dependent thematic-break refusal, relabeled v3 provenance, or an unbounded child wait |
...
- [0082 — Refine rich Markdown runner closure](0082-refine-rich-markdown-runner-closure.md)
