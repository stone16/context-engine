...
| Local read-only consumers | [0086 — Bind local consumers to fresh evidence-bearing Packages](0086-bind-local-consumers-to-fresh-evidence-bearing-packages.md) | Each question acquires one fresh unexpired loopback Package and renders every Block with its single Evidence ref while the environment-held bearer stays out of invocation and session state | Package reuse, post-expiry use, stripped citation lineage, persisted or argument-carried secrets, or widening the local consumer into BotDelivery |
