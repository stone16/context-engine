...
/ui/articles                Article lookup
/ui/articles/{resourceRef}  visibility policy, rung, and confirmed edit
...
| `/ui/articles/{resourceRef}` | record detail | Understand and explicitly change one Article policy |
...
6. Answer/Hit Test → `/ui/feedback` → record evidence → return to answer.
