...
import { resolveContextV1 } from "./generated/sdk.gen.js";
import type {
  AcquireWire,
...
export class ContextEngineHttpError extends Error {
  readonly body: ResolveContextV1Error;
  readonly status: number;

  constructor(status: number, body: ResolveContextV1Error) {
...
export class ContextEngineResolveClient {
  ...
  async resolve(options: ResolveContextOptions): Promise<ResolutionOutcomeV1Wire> {
    ...
    const result = await resolveContextV1({
