...
def make_catalog() -> dict[str, object]:
    ...
    return {
        ...
        "activations": [
            ...
            copy.deepcopy(CANONICAL_DOGFOOD_AUTHENTICATION_ACTIVATION),
        ...
        "properties": {
            ...
            "activations": {
                ...
                "prefixItems": [
                    ...
                    {"const": copy.deepcopy(CANONICAL_DOGFOOD_RUNTIME_ACTIVATION)},
                ],
                "items": False,
            },
            "invariants": {
...
class ValidateSecurityCatalogTests(unittest.TestCase):
    ...
    def test_issue_71_activates_private_accept_012_without_rewriting_m0_history(
        ...
        self.assertEqual(
            object_list_at(catalog, "activations")[-10],
            CANONICAL_PRIVATE_BOT_DELIVERY_ACTIVATION,
        )
    ...
    def test_issue_93_file_reclaim_activation_is_independently_frozen(self) -> None:
        ...
        schema_activation = object_at(
            cast(dict[str, object], prefix_items[-3]), "const"
        )
    ...
    def test_issue_81_file_change_activation_stops_before_scheduling(self) -> None:
        ...
        self.assertEqual(
            [item["id"] for item in object_list_at(activation, "testEvidence")],
            [
                "PG-FILE-CHANGE-ACTIVATE-081",
                "PG-FILE-CHANGE-PAGE-081",
