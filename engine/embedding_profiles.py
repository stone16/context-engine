"""Pure immutable embedding profile authority shared across engine loops."""
...
QWEN3_EMBEDDING_PROFILE = EmbeddingProviderProfile(
    ...
    artifact_digest="8cb25677d5be69ce6ac88ebbdfb5dad30980fee39c35c6324a583e325917eddc",
    dimension=CONTEXT_FRAGMENT_EMBEDDING_DIMENSION,
    pooling="last_token",
    query_prefix=(
...
_REGISTERED = {
    ...
    for profile in (DETERMINISTIC_TWIN_EMBEDDING_PROFILE, QWEN3_EMBEDDING_PROFILE)
}
...
def registered_embedding_provider_profile(
    ...
    try:
        return _REGISTERED[(canonical_document, profile_digest)]
