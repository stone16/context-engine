...
class ControlOperation(StrEnum):
    ...
    COMMIT_BULK_ARTICLE_POLICY_CHANGE = "commit_bulk_article_policy_change"
    EXECUTE_FILE_DELETE_OBSERVATION = "execute_file_delete_observation"
    IMPORT_FILE = "import_file"
    OFFBOARD_FILE_SOURCE = "offboard_file_source"
    PREVIEW_BULK_ARTICLE_POLICY_CHANGE = "preview_bulk_article_policy_change"
    REGISTER_SOURCE = "register_source"
    READ_ARTICLE_POLICY = "read_article_policy"
